...
public:
	...
	void step()
	{
		// TODO: Implement instructions 0x47-0x4F
		/*
...
#endif
			regs.Hf = halfcarry8(regs.A, ~regs.C + 1);
		...
		case 0xBB: // CP E
		{
			...
			regs.Nf = 1;
			regs.Hf = halfcarry8(regs.A, ~regs.E + 1);
		...
		case 0xCE: // ADC A, d8
		{
			...
			regs.Hf = halfcarry8(regs.A, value + carry);
...
#endif
			regs.Hf = halfcarry8(regs.A, ~value + 1);
